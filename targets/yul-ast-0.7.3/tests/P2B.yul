...
object "P2B_54" {
    code {
        ...
        codecopy(0, dataoffset("P2B_54_deployed"), datasize("P2B_54_deployed"))

        return(0, datasize("P2B_54_deployed"))

        function cleanup_t_uint256(value) -> cleaned {
            cleaned := value
        }

        function constructor_P2B_54() {
    ...
    object "P2B_54_deployed" {
        code {
            ...
            function fun_modifyY_43(vloc_newY_29) {

                let expr_33 := 0x02
                let _2 := read_from_storage_offset_0_t_uint256(0x00)
                let expr_34 := _2
                let expr_35 := checked_mul_t_uint256(convert_t_rational_2_by_1_to_t_uint256(expr_33), expr_34)
                ...
                let _4 := vloc_newY_29
                let expr_38 := _4
                let expr_39 := checked_sub_t_uint256(expr_37, expr_38)

                update_storage_value_offset_0t_uint256_to_t_uint256(0x01, expr_39)
                let expr_40 := expr_39

            }

            function fun_observe_53() -> vloc_obsY_46 {
                let zero_value_for_type_t_uint256_5 := zero_value_for_split_t_uint256()
                vloc_obsY_46 := zero_value_for_type_t_uint256_5

                let _6 := read_from_storage_offset_0_t_uint256(0x01)
                let expr_49 := _6
                vloc_obsY_46 := expr_49
                let expr_50 := expr_49
